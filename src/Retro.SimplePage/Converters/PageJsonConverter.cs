...
namespace Retro.SimplePage.Converters;
...
/// During deserialization, it expects a JSON object containing the keys "pageNumber", "pageSize", and "items". Any missing keys will result in a <see cref="Page{T}"/>.
/// During serialization, the <see cref="JsonException"/> object is written as a JSON object with the following keys and values:
